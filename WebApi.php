...
final class Api
{
    ...
    public function handle()
    {
        ...
        $_httpResponse = "Webapi\\Net\\HttpResponse";
    ...
    private function parseRequest()
    {
        ...
        if ($methodNotAllowed) {
            ...
            return new \Webapi\Net\HttpResponse(405, 'Method Not Allowed');
        }
        return new \Webapi\Net\HttpResponse(404, 'Not Found');
    ...
    private function getControllerInfo($class = null, $method = null)
    {
        ...
        $reflects = $class === null ? array_map(function ($class) {
            ...
            return substr_compare(strtolower($class), 'controller', -10) === 0 &&
                is_subclass_of($class, 'Webapi\Mvc\ApiController');
